...
TRAINING_INPUT_FILES = ['data/generated/training_tweets.txt', 'data/generated/training_linkedin.txt', 'data/generated/training_fb.txt']
TRAINING_OUTPUT_FILES = ['llda/tweets_words.txt', 'llda/linkedin_words.txt', 'llda/fb_words.txt']
